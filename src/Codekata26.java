...
public class Codekata26 {
    static class Solution26 {
        public int solution26(int a, int b, int c, int d) {
            int answer = 0;
        ...
        public static void main(String[] args){
            ...
            int result = sol26.solution26(2,2,2,2);
//            int result = sol26.solution26(4,1,4,4);
//            int result = sol26.solution26(6,3,3,6);
